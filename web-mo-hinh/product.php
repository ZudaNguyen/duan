...
// product.php
session_start(); 
include "db/connect.php"; // Thêm dòng include connect.php

$title = "Chi tiết sản phẩm";

// --- THÊM MẢNG NÀY ĐỂ DỊCH CATEGORY ---
$category_map = [
    "SieuXe" => "Siêu Xe",
    "F1" => "Đua F1",
    "Moto" => "Mô Tô",
...
// Truy vấn CSDL để lấy 1 sản phẩm
// (Giả sử tên bảng là 'products' và bạn đã có đủ các cột)
...
$sql_related = "SELECT * FROM products 
                WHERE category = ? AND id != ? 
                LIMIT 4";
$stmt_related = $conn->prepare($sql_related);
$stmt_related->bind_param("si", $current_category, $current_id);
